...
class Name extends React.Component {
	...
	componentDidMount() {
		this.timerId = setInterval(() => this.loadInfo(), 3000);
	}
	handleChange(event) {
	...
	render() {
		...
		return React.createElement(
			...
			React.createElement('input', { type: 'text', onBlur: this.blur, onChange: this.handleChange, defaultValue: this.state.value, placeholder: 'Nota' })
		);
	}
}
